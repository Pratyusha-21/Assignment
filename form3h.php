...
<form action="form3.php" enctype="multipart/form-data" class="container mt-5" method="post">   
...
<footer>
  <nav aria-label="Page navigation example" class="fixed-bottom mb-5">
    <ul class="pagination justify-content-center ">
      <li class="page-item">
        <a class="page-link" href="form2h.php" aria-label="Previous">
      ...
      <li class="page-item">
        <a class="page-link" href="form4h.php" aria-label="Next">
